...
void renderScene()
{
	...
	//Zadanie 4 - obrot modelu 2d o dany kat wokol poczatku ukladu wspolrzednych.

	GLfloat objTurnRadius = 45;														//zmienna przechowujaca kat obrotu
																					//przekazywana do shadera wierzcholkow

	GLint turnRadiusLocation = glGetUniformLocation(shaderProgram, "turnRadius");	//przypisanie adresu lokacji zmiennej
																					//uniform kata obrotu z shadera
																					//wierzcholkow do turnRadiusLocation

	glUniform1f(turnRadiusLocation, objTurnRadius);									//przekazanie zmiennej objTurnRadius
																					//do turnRadiusLocation
